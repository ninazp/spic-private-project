 ...
 */
package com.jeeplus.modules.fea.entity.othercostinfo;
 ...
 * @version 2018-06-15
 */
public class FeaOthercostinfoVO extends DataEntity<FeaOthercostinfoVO> {
	...
	public FeaOthercostinfoVO() {
		super();
	}

	public FeaOthercostinfoVO(String id){
		super(id);
	}
	...
	@ExcelField(title="产品种类", align=2, sort=4)
	...
	@ExcelField(title="产品税（%）", align=2, sort=6)
	...
	@ExcelField(title="产量", align=2, sort=7)
	...
	@ExcelField(title="第2年", align=2, sort=15)
	...
	@ExcelField(title="第3年", align=2, sort=16)
	...
	@ExcelField(title="第4年", align=2, sort=17)
	...
	@ExcelField(title="第5年", align=2, sort=18)
	...
	@ExcelField(title="第6年", align=2, sort=19)
	...
	@ExcelField(title="第7年", align=2, sort=20)
	...
	@ExcelField(title="第8年", align=2, sort=21)
	...
	@ExcelField(title="第9年", align=2, sort=22)
	...
	@ExcelField(title="第10年", align=2, sort=23)
	...
	@ExcelField(title="第11年", align=2, sort=24)
	...
	@ExcelField(title="第12年", align=2, sort=25)
	...
	@ExcelField(title="第13年", align=2, sort=26)
	...
	@ExcelField(title="第14年", align=2, sort=27)
	...
	@ExcelField(title="第15年", align=2, sort=28)
	...
	@ExcelField(title="第16年", align=2, sort=29)
	...
	@ExcelField(title="第17年", align=2, sort=30)
	...
	@ExcelField(title="第18年", align=2, sort=31)
	...
	@ExcelField(title="第19年", align=2, sort=32)
	...
	@ExcelField(title="第20年", align=2, sort=33)
	...
	@ExcelField(title="第21年", align=2, sort=34)
	...
	@ExcelField(title="第22年", align=2, sort=35)
	...
	@ExcelField(title="第23年", align=2, sort=36)
	...
	@ExcelField(title="第24年", align=2, sort=37)
	...
	@ExcelField(title="第25年", align=2, sort=38)
	...
	@ExcelField(title="第26年", align=2, sort=39)
	...
	@ExcelField(title="第27年", align=2, sort=40)
	...
	@ExcelField(title="第28年", align=2, sort=41)
	...
	@ExcelField(title="第29年", align=2, sort=42)
	...
	@ExcelField(title="第30年", align=2, sort=43)
	...
	@ExcelField(title="第31年", align=2, sort=44)
	...
	@ExcelField(title="第32年", align=2, sort=45)
