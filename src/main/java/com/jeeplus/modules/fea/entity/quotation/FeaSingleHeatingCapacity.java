 ...
 * @version 2018-02-08
 */
public class FeaSingleHeatingCapacity extends DataEntity<FeaSingleHeatingCapacity> {
	
	private static final long serialVersionUID = 1L;
	private FeaProjectB feaProjectB;		// 项目
	private Office office;		// 部门
	
	public FeaSingleHeatingCapacity() {
		super();
	}

	public FeaSingleHeatingCapacity(String id){
		super(id);
	}
