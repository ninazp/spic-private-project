...
$(document).ready(function() {
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	edit(row.id);
                        ...
                        jp.confirm('确认要删除该成本种类及产量记录吗？', function(){
                       	jp.loading();
  ...
  function deleteAll(){
   ...
   function add(){
	  jp.openDialog('新增成本种类及产量', "${ctx}/fea/costinfo/fea_costinfoVO/form",'800px', '500px', $('#fea_costinfoVOTable'));
  }
  function edit(id){//没有权限时，不显示确定按钮
	  ...
	  jp.openDialog('编辑成本种类及产量', "${ctx}/fea/costinfo/fea_costinfoVO/form?id=" + id,'800px', '500px', $('#fea_costinfoVOTable'));
	   </shiro:hasPermission>
	  <shiro:lacksPermission name="fea:costinfo:fea_costinfoVO:edit">
	  jp.openDialogView('查看成本种类及产量', "${ctx}/fea/costinfo/fea_costinfoVO/form?id=" + id,'800px', '500px', $('#fea_costinfoVOTable'));
