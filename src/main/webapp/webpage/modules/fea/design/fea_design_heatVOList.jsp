...
<head>
	...
	<%@include file="fea_design_heatVOList.js" %>
	...
	<script type="text/javascript">
		...
		function selectproject(){
			...
			jp.get("${ctx}/fea/design/fea_design_heatVO/getFormByProjectId?feaProjectId="+node.id,function(data){
...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="fea_design_heatVO" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<%-- <shiro:hasPermission name="fea:design:fea_design_heatVO:add">
			...
			<%-- <shiro:hasPermission name="fea:design:fea_design_heatVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission> --%>
			<%-- <shiro:hasPermission name="fea:design:fea_design_heatVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/design/fea_design_heatVO/import" method="post" enctype="multipart/form-data"
