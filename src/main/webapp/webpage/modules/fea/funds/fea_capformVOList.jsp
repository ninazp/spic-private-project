...
<head>
	...
	<%@include file="fea_capformVOList.js" %>
	...
	<script type="text/javascript">
		...
		function selectproject(){
			...
			jp.get("${ctx}/fea/funds/fea_capformVO/getFormByProjectId?feaProjectId="+node.id,function(data){
	    ...
	    $(document).ready(function() {
			...
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/fea/funds/fea_capformVO/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="fea_capformVO" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<%-- <shiro:hasPermission name="fea:funds:fea_capformVO:add">
			...
			<%-- <shiro:hasPermission name="fea:funds:fea_capformVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission> --%>
			<%-- <shiro:hasPermission name="fea:funds:fea_capformVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/funds/fea_capformVO/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<!-- <table id="fea_capformVOTable"   data-toolbar="#toolbar"></table> -->
	<form:form id="inputForm" modelAttribute="fea_capformVO" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
