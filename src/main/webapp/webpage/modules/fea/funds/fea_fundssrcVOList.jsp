...
<head>
	...
	<%@include file="fea_fundssrcVOList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">资金来源列表</h3>
	</div>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="fea:funds:fea_fundssrcVO:add">
			...
			<shiro:hasPermission name="fea:funds:fea_fundssrcVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="fea:funds:fea_fundssrcVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/funds/fea_fundssrcVO/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="fea_fundssrcVOTable"   data-toolbar="#toolbar"></table>
