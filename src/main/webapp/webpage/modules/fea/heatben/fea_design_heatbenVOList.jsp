...
<head>
	...
	<%@include file="fea_design_heatbenVOList.js" %>
	...
	<script type="text/javascript">
		function selectproject(){
			...
			$('#fea_design_heatbenVOTable').bootstrapTable('refresh',opt);
			//alert("选中了："+node.text);
		}
	</script>
</head>
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">热泵价格列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="fea_design_heatbenVO" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="fea:heatben:fea_design_heatbenVO:add">
			...
			<shiro:hasPermission name="fea:heatben:fea_design_heatbenVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="fea:heatben:fea_design_heatbenVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/heatben/fea_design_heatbenVO/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="fea_design_heatbenVOTable"   data-toolbar="#toolbar"></table>
