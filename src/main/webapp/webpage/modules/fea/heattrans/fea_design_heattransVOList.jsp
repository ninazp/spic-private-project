...
<head>
	...
	<%@include file="fea_design_heattransVOList.js" %>
	...
	<script type="text/javascript">
		function selectproject(){
			...
			$('#fea_design_heattransVOTable').bootstrapTable('refresh',opt);
			//alert("选中了："+node.text);
		}
	</script>
</head>
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">换热器价格列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="fea_design_heattransVO" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="fea:heattrans:fea_design_heattransVO:add">
			...
			<shiro:hasPermission name="fea:heattrans:fea_design_heattransVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="fea:heattrans:fea_design_heattransVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/heattrans/fea_design_heattransVO/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="fea_design_heattransVOTable"   data-toolbar="#toolbar"></table>
