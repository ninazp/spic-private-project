...
<head>
	...
	<%@include file="fea_incomesetVOList.js" %>
	...
	<script type="text/javascript">
		...
		function selectproject(){
			...
			jp.get("${ctx}/fea/income/fea_incomesetVO/getFormByProjectId?feaProjectId="+node.id,function(data){
...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="fea_incomesetVO" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<%-- <shiro:hasPermission name="fea:income:fea_incomesetVO:add">
			...
			<%-- <shiro:hasPermission name="fea:income:fea_incomesetVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission> --%>
			<%-- <shiro:hasPermission name="fea:income:fea_incomesetVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/income/fea_incomesetVO/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<!--<table id="fea_incomesetVOTable"   data-toolbar="#toolbar"></table> -->
