...
$(document).ready(function() {
  ...
  function add(){
	  jp.openDialog('新增生成成本', "${ctx}/fea/procost/fea_productcostVO/form",'800px', '500px', $('#fea_productcostVOTable'));
  }
  ...
  function edit(id){//没有权限时，不显示确定按钮
	  ...
	  jp.openDialog('编辑生成成本', "${ctx}/fea/procost/fea_productcostVO/form?id=" + id,'800px', '500px', $('#fea_productcostVOTable'));
	   </shiro:hasPermission>
	  <shiro:lacksPermission name="fea:procost:fea_productcostVO:edit">
	  jp.openDialogView('查看生成成本', "${ctx}/fea/procost/fea_productcostVO/form?id=" + id,'800px', '500px', $('#fea_productcostVOTable'));
