...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">生产成本列表</h3>
	</div>
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="fea:procost:fea_productcostVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="fea:procost:fea_productcostVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/procost/fea_productcostVO/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="fea_productcostVOTable"   data-toolbar="#toolbar"></table>
