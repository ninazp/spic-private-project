...
<head>
	...
	<script type="text/javascript">
		function selectproject(){
			...
			$('#fea_design_setVOTable').bootstrapTable('refresh',opt);
			//alert("选中了："+node.text);
		}
	</script>
</head>
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="fea:set:fea_design_setVO:add">
			...
			<shiro:hasPermission name="fea:set:fea_design_setVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="fea:set:fea_design_setVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/set/fea_design_setVO/import" method="post" enctype="multipart/form-data"
