...
<head>
	...
	<%@include file="fea_incosubsidyVOList.js" %>
...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">补贴收入列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="fea_incosubsidyVO" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="fea:subsidy:fea_incosubsidyVO:add">
			...
			<shiro:hasPermission name="fea:subsidy:fea_incosubsidyVO:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="fea:subsidy:fea_incosubsidyVO:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fea/subsidy/fea_incosubsidyVO/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="fea_incosubsidyVOTable"   data-toolbar="#toolbar"></table>
