	...
	<script>
		...
		function init(projectIds){
			if(projectIds.length ==0){
 				jp.get("${ctx}/feareport/report2/getProjectDatas?ids=" + projectIds, function (data) {
 					if(data.success){
		...
		function execute(projectIds){
			...
			jp.get("${ctx}/feareport/report2/getReportDatas?ids=" + projectIds +"&timestamp="+timestamp, function (data) {
				var datas = data.msg;
