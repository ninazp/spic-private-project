...
<html>
<head>
	<title>项目资本金现金流量表管理</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="report3List.js" %>
...
<%-- 	<script src="${ctxStatic}/common/js/exportReportUtil.js"></script> --%>
	...
	<script>
		...
		function execute(projectIds){
			...
			jp.get("${ctx}/feareport/report3/getReportDatas?ids=" + projectIds +"&timestamp="+timestamp, function (data) {
				var datas = data.msg;
	...
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">项目资本金现金流量表列表</h3>
			</div>
