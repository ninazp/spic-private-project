...
<%-- 	<script src="${ctxStatic}/common/js/exportReportUtil.js"></script> --%>
	...
	<script>
		...
		function execute(projectIds){
			...
			jp.get("${ctx}/feareport/report7/getReportDatas?ids=" + projectIds+"&timestamp="+timestamp, function (data) {
				if(data.success){
      	  			//初始化报表
					initreport(data.msg);
      	  		}else{
...
["19","息税折旧摊销前利润"] */
	    	...
	    	hot = new Handsontable(hotElement, hotSettings);
			   ...
			   */
			 //填充报表数据
		     hot.populateFromArray(4, 2, array, 24, colLeg+1, "populateFromArray", "overwrite", null, null);
		     //填充年份数据
