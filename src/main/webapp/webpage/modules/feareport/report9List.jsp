	...
	<script>
		...
		function init(projectIds){
			if(projectIds.length ==0){
 				jp.get("${ctx}/feareport/report9/getProjectDatas?ids=" + projectIds, function (data) {
 					if(data.success){
		...
		function execute(projectIds){
			...
			jp.get("${ctx}/feareport/report9/getReportDatas?ids=" + projectIds	 +"&timestamp="+timestamp, function (data) {
				if(data.success){
      	  			//初始化报表
					initreport(data.msg);
      	  		}else{
	...
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">资产负债表列表</h3>
			</div>
