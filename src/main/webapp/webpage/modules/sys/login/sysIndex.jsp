...
<body class="">
	<nav class="navbar topnav-navbar navbar-fixed-top" role="navigation">
		<%-- <div class="navbar-header text-center">
			<img  class="img-circleSp" src="${ctxStatic}/common/images/zdt_03.png" class="user-avatar" height="50" width="200" />
		</div> --%>
		...
		<div class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav pull-right navbar-right">	
				...
				<li class="dropdown admin-dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
						<img  class="img-circleSp" src="${ctxStatic}/common/images/user.png" height="30" width="30" class="user-avatar" />
	...
	<section id="body-container" class="animation">
		...
		<div class="main-container" id="main-container">
           ...
           <div class="footer">
                <div class="pull-left"><a href="http://www.spic.com.cn/">http://www.spic.com.cn/</a> &copy; Copyright © 国家电力投资集团公司版权所有2002-2016</div>
            </div>
